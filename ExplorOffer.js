      ...
      <section className="offerings">
        <div className="titles-column">
          {offeringsData.map((offering, index) => (
            <div
              key={index}
              className={`offering-title ${index === activeOffering ? 'active' : ''}`}
          ...
          {activeOffering !== null && (
            <div className="offering-info">
              ...
              {offeringsData[activeOffering].description && (
                <p className="description">{offeringsData[activeOffering].description}</p>
              )}
              {offeringsData[activeOffering].services && (
                <ul className="services-list">
                {offeringsData[activeOffering].services.map((service, serviceIndex) => (
  <li key={serviceIndex}>{service}</li>
))}

                </ul>
              )}
              <a className="explore-link" href="#">Explore Further</a>
            </div>
          )}
        </div>
      </section>
